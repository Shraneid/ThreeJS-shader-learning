...
import vertexShaderCode from "./shaders/wave/a_vertex.glsl";
import fragmentShaderCode from "./shaders/wave/a_fragment.frag";
...
class BasicWorldDemo {
    ...
    async _Initialize() {
        ...
        const box = new THREE.Mesh(
            new THREE.BoxGeometry(32, 8, 64, 10, 10, 64),
