    ...
    _RequestAnimationFrame() {
        ...
        requestAnimationFrame(() => {
            ...
            const rotation_vector = new THREE.Vector3(
                Math.sin(this._clock.getElapsedTime() * rotation_speed),
                0,
                Math.cos(this._clock.getElapsedTime() * rotation_speed)
            );
            const new_pos = rotation_vector.multiplyScalar(this._distance);
            console.log(new_pos);

            this._camera.position.set(new_pos.x, new_pos.y, new_pos.z);
